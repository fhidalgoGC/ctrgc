...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    testgitAuthUserSubject.add(
      TestgitAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<TestgitAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  TestgitAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = TestgitAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    testgitAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
